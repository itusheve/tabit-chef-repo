...
@Component({
  selector: 'app-week-promotions',
  templateUrl: './week-promotions.component.html',
  styleUrls: ['./week-promotions.component.scss']
})
export class WeekPromotionsComponent implements OnInit, OnChanges {
  ...
  title = {en: 'Promotion', translated: 'month.promotion'};
