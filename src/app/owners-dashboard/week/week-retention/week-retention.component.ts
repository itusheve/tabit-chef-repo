...
@Component({
  ...
  templateUrl: './week-retention.component.html',
  styleUrls: ['./week-retention.component.scss']
})
export class WeekRetentionComponent extends AbstractWeekComponent implements OnInit, OnChanges {
  ...
  title = { en: 'retention', translated: 'month.retention' };
