...
@Component({
  selector: 'app-week-corporation-return',
  templateUrl: './week-corporation-return.component.html',
  styleUrls: ['./week-corporation-return.component.scss']
})
export class WeekCorporationReturnComponent implements OnInit, OnChanges {
  ...
  title = {en: 'CorporationReturn', translated: 'month.corporationRefund'};
