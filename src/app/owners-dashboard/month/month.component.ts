...
export class MonthComponent implements OnInit {
    ...
    getReductionData(key, dataOption,percentKey) {
        ...
        return Object.assign(data,{isShowing:data.primary.length > 0 || data.alt.length > 0,percent:this.summary[0].totals ? this.summary[0].totals.reductions[percentKey] ? this.summary[0].totals.reductions[percentKey].percentage : 0:0});
    }
