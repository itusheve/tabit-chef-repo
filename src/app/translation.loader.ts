...
const he = {
    ...
    'day.salesWithTax': 'מכירות כולל מע"מ',
    'day.server': 'מלצר',
    'day.serviceCharge': '',
    'day.sold': 'נמכר',
    'day.table': 'שולחן',
    ...
    'month.dialog.fetching':'מוריד נתונים',
    ...
    'month.prepared': 'הוכן',
    'month.returned': 'הוחזר',
    'month.refund': 'החזרים כספיים',
    'month.operationalReductionsValue': 'שווי בעיות תפעול',
    'month.order': 'מספר הזמנה',
    'month.payments': 'אמצעי תשלום',
    'week.server': 'מלצר',
    'week.quantity': 'כמות',
    'week.amount': 'סכום',
    'revenue': 'מחזור',
...
const en = {
    ...
    'month.retention': 'Retention',
    'month.waste': 'Waste',
    'month.promotion': 'Promotion',
    'month.organizational': 'Organizational',
    'month.corporationRefund': 'CorporationReturn',
    'month.corporation': 'Corporation',
    'month.prepared': 'Prepared',
    'month.returned': 'Returned',
    'month.operationalReductionsValue': 'OperationalReductionsValue',
    'month.server': 'Server',
